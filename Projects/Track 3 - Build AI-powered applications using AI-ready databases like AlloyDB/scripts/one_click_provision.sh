...
APP_NL_TO_SQL_TEMPLATE="${APP_NL_TO_SQL_TEMPLATE:-select generated_sql from alloydb_ai_nl('{question}')}"
...
if [[ -z "${DB_PASSWORD:-}" ]]; then
  ...
  echo "Using default non-production DB_PASSWORD from provisioner."
else
